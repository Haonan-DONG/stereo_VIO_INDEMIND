...
public:
  ...
  void onInit() override {
    ...
    m_left_image_publisher =
        it_imsee.advertiseCamera("/imsee/image/left", 10, true);
    m_right_image_publisher =
        it_imsee.advertiseCamera("/imsee/image/right", 10, true);
    // m_rectified_left_image_publisher =
    //     it_imsee.advertiseCamera("/imsee/image/rectified/left", 10, true);
    // m_rectified_right_image_publisher =
    //     it_imsee.advertiseCamera("/imsee/image/rectified/right", 10, true);
    ...
    m_imu_publisher = nh_.advertise<sensor_msgs::Imu>("/imsee/imu", 200);
    if (m_pSDK) {
